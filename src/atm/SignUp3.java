...
public class SignUp3 extends Jframe implements ActionListener {
    ...
    SignUp3(){
        ...
        Label l5 = new JLabel("(Your 16-Digit Card NUmber)");
        l5.setFont(new Font("Rale way", Font.BOLD,12));
        l5.setBounds(100, 330,200,20);
        add(l5);

        Label l6 = new JLabel("XXXX-XXXX-XXXX-4841");
        l6.setFont(new Font("Rale way", Font.BOLD,12));
        l6.setBounds(330,300,250,20);
        add(l6);

        Label l7 = new JLabel("(It would appear on atm card/cheque Book and Statements)");
        ...
        Label l10 = new JLabel("(4-Digit Password)");
        ...
        JCheckBox c7 = new JCheckBox("I here by Declares that the abpbe entered details correct to the best of my knowledge ",true);
        ...
        try{
            if(e.getSource()==s){
                if(atype.equals("")){
                    ...
                    String q2 = "insert into table login values('"+formno+"','"+cardno+"','"+pin+"')";
